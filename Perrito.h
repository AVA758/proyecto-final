...
class Adulto: public Perrito{
    ...
    public:
        Perrito(): id(0), raza(""), edad(0), tam(0.0), peso(0.0), salidas(0){};

        Perrito(int n, string raz, int ed, float ta, float pes, int sal): id(n), raza(raz), edad(ed),tam(ta), peso(pes), salidas(sal){};
...
float Adulto::get_salidas() const{
  return salidas
}
...
class Cachorro: public Perrito{
    ...
    public:
        Perrito(): id(0), raza(""), edad(0), tam(0.0), peso(0.0), hor(0) {},

        Perrito(int n, string raz, int ed, float ta, float pes, float sal): id(n), raza(raz), edad(ed),tam(ta), peso(pes), horasDeJuego(hor){};
